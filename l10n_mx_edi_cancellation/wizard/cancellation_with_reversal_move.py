...
class PaymentCancellationWithReversalMove(models.TransientModel):
    ...
    date = fields.Date(
        string="Reversal date", default=fields.Date.context_today, required=True, help="Date of the reversal move"
    )
    ...
    def cancel_with_reversal_move(self):
        ...
        self.env["account.payment"].browse(payment_ids).l10n_mx_edi_cancel_with_reversal(self.date, self.journal_id)
