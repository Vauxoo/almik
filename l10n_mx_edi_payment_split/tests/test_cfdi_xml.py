...
from odoo.addons.l10n_mx_edi_40.tests.common import (
    TestMxEdiCommon,
    mocked_l10n_mx_edi_pac,
)
...
class TestSplitPayment(TestMxEdiCommon):
    ...
    def create_payment(
        ...
        register.l10n_mx_edi_payment_method_id = self.env.ref("l10n_mx_edi.payment_method_efectivo")
        if csv:
    ...
    def test_payment_mxn(self):
        with freeze_time(self.frozen_today), mute_logger("py.warnings"), patch(
                ...
                .create(
                    {
                        ...
                        "date": "2016-12-31",
                        "invoice_line_ids": [
                            (0, 0, {"product_id": self.product.id, "price_unit": 100, "tax_ids": False})
                        ],
                    }
                )
            )
                ...
                .create(
                    {
                        ...
                        "date": "2016-12-31",
                        "invoice_line_ids": [
                            (0, 0, {"product_id": self.product.id, "price_unit": 5.0, "tax_ids": False})
                        ],
                    }
                )
            )
                ...
                .create(
                    {
                        ...
                        "date": "2016-12-31",
                        "invoice_line_ids": [
                            (0, 0, {"product_id": self.product.id, "price_unit": 4.4, "tax_ids": False})
                        ],
                    }
                )
            )
            ...
            receivable_lines = payment_record.line_ids.filtered(
            ...
            expected_etree = self.with_applied_xpath(
                ...
                """
                    <xpath expr="//Comprobante" position="attributes">
                        ...
                        <attribute name="Serie">PJBMXN/2017/</attribute>
                    </xpath>
                        ...
                        <Complemento>
                            <Pagos Version="2.0">
                                ...
                                <Pago
                                    ...
                                    FormaDePagoP="01" MonedaP="MXN" Monto="239.00" TipoCambioP="1"
            ...
            self.assertEqual(round(line_eur.amount_currency, 1), -1.4)
                    ...
                    <xpath expr="//Complemento" position="replace">
                        <Complemento>
                            <Pagos Version="2.0">
                                ...
                                <Pago
                                    FechaPago="2017-01-01T12:00:00"
                                    FormaDePagoP="01" MonedaP="MXN" Monto="69.65" TipoCambioP="1"
                                    NumOperacion="INV/2016/00001 INV/2016/00002 INV/2016/00003">
                                        <DoctoRelacionado
    ...
    def test_payment_usd_one_payment_default_rate(self):
        with freeze_time(self.frozen_today), mute_logger("py.warnings"), patch(
            ...
            self.assertEqual(line_mxn.amount_currency, -100)
            ...
            expected_etree = self.with_applied_xpath(
                ...
                """
                    <xpath expr="//Comprobante" position="attributes">
                        <attribute name="Folio">1</attribute>
                        <attribute name="Serie">PJBUSD/2017/</attribute>
                    </xpath>
                    <xpath expr="//Complemento" position="replace">
                        <Complemento>
                            <Pagos Version="2.0">
                                <Totales MontoTotalPagos="225.00"/>
                                <Pago
                                    FechaPago="2017-01-01T12:00:00"
                                    FormaDePagoP="01" MonedaP="USD"
                                    TipoCambioP="25.000000" Monto="9.00"
    ...
    def test_payment_usd_one_payment_custom_rate_at_line(self):
        with freeze_time(self.frozen_today), mute_logger("py.warnings"), patch(
            ...
            self.assertEqual(line_mxn.amount_currency, -72)
            self.assertEqual(line_usd.balance, -125)
            self.assertEqual(line_usd.amount_currency, -5)
            ...
            expected_etree = self.with_applied_xpath(
                ...
                """
                    ...
                    <xpath expr="//Complemento" position="replace">
                        <Complemento>
                            <Pagos Version="2.0">
                                <Totales MontoTotalPagos="197.00"/>
                                <Pago
                                    FechaPago="2017-01-01T12:00:00"
                                    FormaDePagoP="01" MonedaP="USD"
                                    TipoCambioP="24.625000" Monto="8.00"
                                    NumOperacion="INV/2016/00001 INV/2016/00002">
                                        <DoctoRelacionado
                                            EquivalenciaDR="1" IdDocumento="567891234" Folio="2" Serie="INV/2016/"
                                            MonedaDR="USD" NumParcialidad="1" ObjetoImpDR="01"
    ...
    def test_partial_payment(self):
        with freeze_time(self.frozen_today), mute_logger("py.warnings"), patch(
            ...
            payment_amount = pline_usd.payment_amount / 2
            pline_usd.payment_currency_amount = (pline_usd.payment_currency_amount / 2) - 10
            pline_usd.payment_amount = payment_amount
            payment._compute_from_lines()
            payment.amount = payment.company_currency_amount

            payment_record = payment._create_split_payments()

            self.assertAlmostEqual(pline_usd.invoice_id.amount_residual, payment_amount)
            ...
            expected_etree = self.with_applied_xpath(
                ...
                """
                    ...
                    <xpath expr="//Complemento" position="replace">
                        <Complemento>
                            <Pagos Version="2.0">
                                <Totales MontoTotalPagos="52.50"/>
                                <Pago
                                    FechaPago="2017-01-01T12:00:00"
                                    FormaDePagoP="01" MonedaP="MXN" Monto="52.50" TipoCambioP="1"
                                    NumOperacion="INV/2016/00001">
                                        <DoctoRelacionado
                                            EquivalenciaDR="0.0476190477"
                                            IdDocumento="567891234" Folio="1" Serie="INV/2016/"
                                            MonedaDR="USD" NumParcialidad="1" ObjetoImpDR="01"
                                            ImpSaldoAnt="5.00" ImpPagado="2.50" ImpSaldoInsoluto="2.50"/>
                                    </Pago>
                            </Pagos>
                        </Complemento>
                    </xpath>
            ...
            self.assertEqual(payment.amount, 62.5)
            self.assertEqual(payment.payment_difference, 0)
            self.assertEqual(payment.company_difference, 0)
            ...
            expected_etree = self.with_applied_xpath(
                ...
                """
                    ...
                    <xpath expr="//Complemento" position="replace">
                        <Complemento>
                            <Pagos Version="2.0">
                                <Totales MontoTotalPagos="62.50"/>
                                <Pago
                                    FechaPago="2017-01-01T12:00:00"
                                    FormaDePagoP="01" MonedaP="MXN" Monto="62.50" TipoCambioP="1"
                                    NumOperacion="INV/2016/00001">
                                        <DoctoRelacionado
                                            EquivalenciaDR="0.0400000000"
                                            IdDocumento="567891234" Folio="1" Serie="INV/2016/"
                                            MonedaDR="USD" NumParcialidad="2" ObjetoImpDR="01"
                                            ImpSaldoAnt="2.50" ImpPagado="2.50" ImpSaldoInsoluto="0.00"/>
                                    </Pago>
                            </Pagos>
                        </Complemento>
                    </xpath>
    ...
    def test_payment_usd_mxn(self):
        """Create invoice in MXN and payment in USD"""
        self.certificate._check_credentials()
        self.invoice.invoice_date = False
        self.mxn = self.env.ref("base.MXN")
        self.usd = self.env.ref("base.USD")
        self.usd.search([("name", "=", "USD")]).unlink()
        self.usd.name = "USD"
        self.usd.active = True
        self.invoice.currency_id = self.mxn
        ...
        self.usd.rate_ids = [(0, 0, {"rate": 0.05, "name": self.invoice.invoice_date})]
        total = self.mxn._convert(invoice.amount_total, self.usd, invoice.company_id, invoice.date)
        self.journal_usd.currency_id = self.usd
        payment = self.create_payment(invoice, "outbound", self.journal_usd, date=invoice.invoice_date)
        pline_mxn = payment.payment_invoice_ids
        pline_mxn.payment_currency_amount = total
        pline_mxn.payment_amount = invoice.amount_total
        payment._compute_from_lines()
        payment.amount = payment.company_currency_amount
        payment_record = payment.action_create_payments()
        payment_record = self.env[payment_record["res_model"]].browse(payment_record["res_id"])
        generated_files = self._process_documents_web_services(payment_record.move_id, {"cfdi_3_3"})
        self.assertTrue(generated_files, payment_record.move_id.edi_error_message)
        ...
        expected_etree = self.with_applied_xpath(
            self.get_xml_tree_from_string(self.expected_payment_cfdi_values),
            f"""
                <xpath expr="//Complemento//Pagos" position="replace">
                    <Complemento xmlns:pago20="http://www.sat.gob.mx/Pagos20" >
                        <pago20:Pagos Version="2.0">
                            <pago20:Totales MontoTotalPagos="8480.00" TotalRetencionesISR="800.00"
                                TotalTrasladosBaseIVA16="8000.00"
                                TotalTrasladosImpuestoIVA16="1280.00"
                                />
                                <pago20:Pago FechaPago="___ignore___" FormaDePagoP="01" MonedaP="USD"
                                        TipoCambioP="20.000000" Monto="424.00" NumOperacion="INV/{invoice.date.year}/00001">
                                    <pago20:DoctoRelacionado IdDocumento="___ignore___" Folio="1" Serie="___ignore___"
                                            MonedaDR="MXN" EquivalenciaDR="20.0000000000" NumParcialidad="1"
                                            ImpSaldoAnt="8480.00" ImpPagado="8480.00" ObjetoImpDR="02"
                                            ImpSaldoInsoluto="0.00">
                                        <pago20:ImpuestosDR>
                                            <pago20:RetencionesDR>
                                                <pago20:RetencionDR BaseDR="8000.00" ImpuestoDR="001"
                                                    TipoFactorDR="Tasa" TasaOCuotaDR="0.100000" ImporteDR="800.00"/>
                                            </pago20:RetencionesDR>
                                            <pago20:TrasladosDR>
                                    ...
                                    <pago20:ImpuestosP>
                                        <pago20:RetencionesP>
                                            <pago20:RetencionP ImpuestoP="001" ImporteP="40.00"/>
                                        </pago20:RetencionesP>
                                        <pago20:TrasladosP>
                                            <pago20:TrasladoP BaseP="400.00" ImpuestoP="002" TipoFactorP="Tasa"
                                                TasaOCuotaP="0.160000" ImporteP="64.00"/>
                                        </pago20:TrasladosP>
                                    </pago20:ImpuestosP>
                                </pago20:Pago>
                        </pago20:Pagos>
        ...
        namespaces = {"pago20": "http://www.sat.gob.mx/Pagos20"}
        self.assertXmlTreeEqual(
            current_etree.xpath("//pago20:Pagos", namespaces=namespaces)[0],
            expected_etree.xpath("//pago20:Pagos", namespaces=namespaces)[0],
        )
